#ifndef __HDL_LIST_H__
#define __HDL_LIST_H__
...
/**
 * @brief RSHash Hash Function from Robert Sedgwicks Algoritls in C book
...
typedef struct hdl_list
{
    ...
    // TODO: Add flag indicating value comming from OpenCL,
    // TODO: Better approach will be to use callback for proper free function
    // convinient for the hdl_element->value type;
